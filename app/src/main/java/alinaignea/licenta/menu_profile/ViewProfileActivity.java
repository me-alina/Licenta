            ...
            protected void onPostExecute(String result){
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        ratingVal.setOnTouchListener(new View.OnTouchListener() {
    ...
    private class LoadImage extends AsyncTask<String, String, Bitmap> {
        ...
        protected void onPostExecute(Bitmap image) {
            ...
            if(image != null){
                ...
                pDialog.dismiss();
                Toast.makeText(ViewProfileActivity.this, "Image Does Not exist or Network Error", Toast.LENGTH_SHORT).show();
